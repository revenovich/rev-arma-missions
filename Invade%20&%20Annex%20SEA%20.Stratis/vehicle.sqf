/*
  ...
  veh = [this, 60, 400, 0, FALSE, FALSE] execVM "vehicle.sqf"
*/
  ...
  if (_dead) then
	{
		...
		[[[_unit],"scripts\DLM_unitSetup.sqf"],"BIS_fnc_execVM",nil,true] spawn BIS_fnc_MP;
		//if(isServer) then {[_unit] execVM "scripts\DLM_markerFollow.sqf"};
