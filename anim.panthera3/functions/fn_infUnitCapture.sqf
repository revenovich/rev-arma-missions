...
[_unit, _duration, _timeOffset] spawn HLF_fnc_infUnitCaptureAnim; // Starts the animation recording script
if (_captureFiring) then
{
	[_unit, _duration, _timeOffset] spawn HLF_fnc_infUnitCaptureFiring; // Starts the weapon fire recording script
	hint "Starting Capture, including weapon fire data...\n\nPress ESC to stop capture.";
}
else
{
