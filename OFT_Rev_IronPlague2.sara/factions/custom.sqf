...
_blackListedLoadouts = ["LOADOUT COMMANDER", "LOADOUT SECOND COMMANDER", "LOADOUT TEAMLEADER", "LOADOUT AT RIFLEMAN", "LOADOUT AUTORIFLEMAN", "LOADOUT GRENADIER", "LOADOUT MARKSMAN", "LOADOUT SNIPER", "LOADOUT SPOTTER", "LOADOUT HELICOPTER PILOT", "LOADOUT HELICOPTER CO-PILOT", "LOADOUT CREWMAN", "LOADOUT UAV OPERATOR"];
