oft_fnc_better_text = {
	[] spawn {
		...
		_texta = "<t font ='EtelkaMonospaceProBold' align = 'center' size='2' color='#841313'>" + "Part 2"+"</t>"; 
		[_texta,/* poz x */ 0,/* poz y */ 0.2,/*durata*/ 5,/* fade in?*/ 1,0,txt6Layer] spawn BIS_fnc_dynamicText;

		sleep 2;

		_texta = "<t font ='EtelkaMonospaceProBold' align = 'center' size='1' color='#841313'>" + "But it is not for us."+"</t>"; 
