oft_fnc_better_text = {
	...
	if (_eventName == "intro1") then {
		_texta = "<t font ='EtelkaMonospaceProBold' align = 'center' size='2' color='#868686ff'>" + "BROKEN PROTOCOL"+"</t><br/><t color='#ffffff' size='0.5'>When a small leak can make a big difference</t>"; 
