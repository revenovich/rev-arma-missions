...

{
	if !(_endSeq) then
	{
		...
		_targetUnit glanceAt _tmpTarget;
		_targetUnit lookAt _tmpTarget;
		_targetUnit doWatch _tmpTarget;
		_targetUnit selectWeapon _tmpWeapon;
		_targetUnit forceWeaponFire [_tmpWeapon, _fireMode];
