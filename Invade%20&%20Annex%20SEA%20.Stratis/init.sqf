//Allows Zeus to edit AI spawned in by scripts in mission
...
[] spawn {
	...
	(findDisplay 46) displayAddEventHandler ["KeyDown", {
		if(_this select 1 == 0x05)
		then {player action ["SWITCHWEAPON",player,player,-1];
...
_handle = execVM "DLM_functions.sqf";
...
//_null = [] execVM "3DR.sqf";
_null = [] execVM "weatherChange.sqf"

execVM "FSNV.sqf";
_null = [] execVM "PrykUav.sqf";
_null = [] execVM "zlt_fieldrepair.sqf";
_null = [] execVM "misc\playerMarkers.sqf";
...
_pos = getMarkerPos (_this select 0);
	...
	for "_x" from 0 to PARAMS_TeamsPatrol do {
		_randomPos = [[[getMarkerPos currentAO, 20],_dt],["water"]] call BIS_fnc_randomPos;
...
while {count _targets > 0} do
{
	...
	_position = [[[getMarkerPos currentAO, PARAMS_AOSize],_dt],["water"]] call BIS_fnc_randomPos;
	...
	_radioTowerDownText = 
		"<t align='center' size='2.2'>Radio Tower</t><br/><t size='1.5' color='#08b000' align='center'>DESTROYED</t><br/>____________________<br/>The enemy radio tower has been destroyed!<br/><br/>Keep up the good work, lads; we're countin' on you.";
	...
	showNotification = ["Reward", "Good Job."]; publicVariable "showNotification";
	...
	[
		"<t align='center' size='2.2'>Target Taken</t><br/><t size='1.5' align='center' color='#FFCF11'>%1</t><br/>____________________<br/><t align='left'>Great job taking %1! Give us a moment here at HQ and we'll line up your next target for you.</t>",
		currentAO
	];
