...
[] spawn {
	...
	["teleportGroup", group_1, teleport_group_target_1] call fn_oft_teleport;
	sleep 2;
	["teleportGroup", group_2, teleport_group_target_2] call fn_oft_teleport;
	sleep 2;
	["teleportGroup", group_3, teleport_group_target_3] call fn_oft_teleport;
	sleep 2;
	["teleportGroup", group_4, teleport_group_target_4] call fn_oft_teleport;
	sleep 2;
	["teleportThings", jamCar_1, teleport_thing_target_1] call fn_oft_teleport;
	sleep 1;
	["teleportThings", veh_inf_truck_1, teleport_thing_target_2] call fn_oft_teleport;
	sleep 1;
	["teleportThings", veh_ammo_truck_1, teleport_thing_target_3] call fn_oft_teleport;
	sleep 1;
	["teleportThings", veh_repair_truck_1, teleport_thing_target_4] call fn_oft_teleport;
	sleep 1;
	["teleportThings", veh_hq_1, teleport_thing_target_5] call fn_oft_teleport;
	sleep 1;
	["teleportThings", tank_1, teleport_thing_target_6] call fn_oft_teleport;
	sleep 1;
	["teleportThings", tank_2, teleport_thing_target_7] call fn_oft_teleport;
	sleep 1;
	["teleportThings", tank_3, teleport_thing_target_8] call fn_oft_teleport;
	sleep 1;
	["teleportThings", tank_4, teleport_thing_target_9] call fn_oft_teleport;
	sleep 1;
	["teleportThings", bradley_1, teleport_thing_target_10] call fn_oft_teleport;
	sleep 1;
	["teleportThings", bmd_4m_1, teleport_thing_target_11] call fn_oft_teleport;
	sleep 2;
